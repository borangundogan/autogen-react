          ...
          <Popover trigger={'hover'} placement={'bottom-start'}>
            <PopoverTrigger>
              <Link
                ...
                fontSize={'sm'}
                fontWeight={500}
                color={location.pathname === navItem.href ? 'brand.800' : linkColor}
                borderBottom={location.pathname === navItem.href ? '2px solid' : 'none'}
    ...
    <Link
      ...
      <Stack direction={'row'} align={'center'}>
        ...
        <Flex
          ...
          align={'center'}
          flex={1}>
          <Icon color={'brand.800'} w={5} h={5} as={ChevronRightIcon} />
        </Flex>
      </Stack>
    </Link>
  );
